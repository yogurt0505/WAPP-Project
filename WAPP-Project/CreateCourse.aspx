<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateCourse.aspx.cs" Inherits="WAPP_Project.CreateCourse" %>
        ...
        <div>
            ...
            <asp:FileUpload ID="file_courseimg" runat="server" accept=".png,.jpg,.jpeg,.gif"/>
             ...
             <label class="form-label" for="txt_url" >Course URL</label>
                ...
                <asp:Button runat="server" ID="btn_create" OnClick="Create_Course_Click" text="Create Course"></asp:Button>
